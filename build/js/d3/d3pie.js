...
(function (root, factory) {
	...
	var segments = {
		...
		addSegmentEventHandlers: function (pie) {
			...
			$(document).on('click', '.js-params-active', function () {
				var currentEl = d3.select(this);
				var segment;
				...
				//console.log(segment);
				//var isExpanded = segment.attr("class") === pie.cssPrefix + "expanded";
				var isExpanded = null === pie.cssPrefix + "expanded";
	...
	var tt = {
		addTooltips: function (pie) {
			...
			tooltips.selectAll("." + pie.cssPrefix + "tooltip")
				...
				.attr("x", pie.options.tooltips.styles.padding + 8)
				.html(function (d, i) {
					var caption = pie.options.tooltips.string;
					if (pie.options.tooltips.type === "caption") {
						caption = d.caption;
					}
					return d.label + ' <tspan style="font-weight: 500;">' + d.percentage + '%</tspan>';
			...
			tooltips.selectAll("." + pie.cssPrefix + "tooltip rect")
				.attr("width", function (d, i) {
					...
					return dims.w + (2 * pie.options.tooltips.styles.padding) + 20;
				})
			...
			tooltips.selectAll("." + pie.cssPrefix + "tooltip")
				...
				.attr("height", 12)
				.attr("width", 12)
				.attr("rx", pie.options.tooltips.styles.borderRadius / 2)
				.attr("ry", pie.options.tooltips.styles.borderRadius / 2)
				.attr("x", 0)
				.attr("y", -10)
				.attr("opacity", "1")
